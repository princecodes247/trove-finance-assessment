...
export function Sidebar() {
  ...
  return (
    <aside className="w-[260px] bg-[#fbfdfb] border-r border-gray-100 flex flex-col hidden sm:flex">
      <div className="p-8 pb-10">
        <h1 className="text-xl font-extrabold text-[#066b59]">Trove</h1>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center px-4 py-3 rounded-lg transition-colors ${
                isActive
                  ? "bg-[#d4e4d4] text-[#066b59] font-medium"
      ...
      <div className="p-6 pt-0">
        ...
        <div className="flex items-center mb-5">
          ...
          <div className="flex flex-col">
            <span className="text-[13px] font-bold text-gray-900 leading-tight">Adaeze Okonkwo</span>
            <span className="text-[11px] text-gray-400 font-medium mt-0.5">Premium Member</span>
          </div>
        </div>
